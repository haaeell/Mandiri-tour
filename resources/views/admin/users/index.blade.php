...
@section('content')
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('users.edit', $user->id) }}" class="btn btn-warning btn-sm"
                                                data-bs-toggle="modal" data-bs-target="#modalEdit{{ $user->id }}"><i
                                                    class="bi bi-pencil-fill"></i></a>
        
                                                    <button class="btn btn-danger delete-btn" data-id="{{ $user->id }}"><i
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            <div class="col-md-2">
                                                                <label for="first-name-horizontal-icon">Name <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <input type="text" class="form-control" placeholder="Name" name="name"
                                                                            id="first-name-horizontal-icon" value="{{$user->name}}" required>
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            <div class="col-md-2">
                                                                <label for="first-name-horizontal-icon">Email <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <input type="text" class="form-control" placeholder="Email"
                                                                            id="first-name-horizontal-icon" value="{{$user->email}}" name="email" required>
                                                                        <div class="form-control-icon">
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            ...
                                                            <div class="col-md-10">
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <input type="number" class="form-control" value="{{$user->phone}}" placeholder="085xxx"  name="phone" required>
                                                                        <div class="form-control-icon">
                                                                ...
                                                                <div class="form-group has-icon-left">
                                                                    <div class="position-relative">
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="role" value="admin" id="adminRadio" {{ $user->role === 'admin' ? 'checked' : '' }}>
                                                                            <label class="form-check-label" for="adminRadio">Admin</label>
                                                                        </div>
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="radio" name="role" value="customer" id="customerRadio" {{ $user->role === 'customer' ? 'checked' : '' }}>
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2 d-flex">
                                ...
                                <div class="col-md-10">
                                    <div class="form-group has-icon-left">
                                        <div class="position-relative">
                                            <input type="text" class="form-control" placeholder="085xxx" id="phone" name="phone" required>
                                            <div class="form-control-icon">
                                                <i class="bi bi-phone"></i>
                                            </div>
                                        </div>
    ...
    {{-- <div class="modal fade" id="modalReset{{$user->id}}" tabindex="-999" aria-hidden="true">
 ...
 <script>
    $(document).ready(function() {
        $('#form-edit').submit(function(e) {
            ...
            var userId = $('#user_id').val(); // Ambil ID pengguna dari input tersembunyi

            // Ganti URL sesuai dengan rute pembaruan
            var url = '{{ route('users.update', ':id') }}'.replace(':id', userId);

            // Tambahkan _method sebagai tanda ini adalah pembaruan (update)
            formData.append('_method', 'PUT');

            $.ajax({
                type: 'POST', // Perhatikan bahwa kita masih menggunakan POST di sini
                url: url,
                data: formData,
                contentType: false,
                processData: false,
