                                            ...
                                            <form action="{{ route('bus.update', $item->id) }}" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            <div class="col-md-2">
                                                                <label for="first-name-horizontal-icon">Kapasitas <span
                                                                        class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="form-group has-icon-left">
                                                        ...
                                                        <div class="mb-2 d-flex">
                                                            <div class="col-md-2">
                                                                <label for="first-name-horizontal-icon">Tipe <span
                                                                        class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-md-10">
                                                                <div class="form-group has-icon-left">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-2 d-flex">
                                    ...
                                    <div class="col-md-10">
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="number" class="form-control" placeholder="kapasitas"
                                                    name="kapasitas" id="first-name-horizontal-icon" required>
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="position-relative">
                                                <input type="text" class="form-control" placeholder="tipe"
                                                    name="tipe" id="first-name-horizontal-icon" required>
                                                <div class="form-control-icon">
                                                    <i class="bi bi-person"></i>
                                                </div>
                                            </div>
